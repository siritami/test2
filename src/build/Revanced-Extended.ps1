...
Invoke-WebRequest -Uri "https://github.com/AutoHotkey/AutoHotkey/releases/download/v2.0.18/AutoHotkey_2.0.18.zip" -OutFile "src\build\AutoHotkey.zip"
...
Start-Process "AutoHotkey64.exe" -ArgumentList "Revanced-Extended.ahk"
